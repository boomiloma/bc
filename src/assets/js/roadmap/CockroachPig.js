...
export default class CockroachPig extends RoadmapUtilities {
  ...
  traverseBigRoadScheme() {
    ...
    while (true) {
      ...
      const leftColLowerIdentity =
        this.identityDictionary[_get(leftColLower, "value")];
      const leftColUpperIdentity =
        this.identityDictionary[_get(leftColUpper, "value")];
