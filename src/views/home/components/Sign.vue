<template>
  ...
  >
    <div class="grid grid-cols-2" style="border: 0">
      <div
        class="flex flex-row justify-center border-b-2 items-center"
        style="padding: 5px 0"
      >
      ...
      <div class="flex flex-row justify-center border-b-2">
        <div
          class="text-2xl w-28 flex flex-row justify-center items-center text-slate-600 border-r-2 font-normal"
        >
          {{ $t("b") }}/{{ $t("p") }}
        </div>
        <div
      ...
      <div class="flex flex-row justify-center border-b-2">
        <div
          class="text-2xl w-28 flex flex-row justify-center items-center text-slate-600 border-r-2"
        >
          {{ $t("t") }}
        </div>
        <div
